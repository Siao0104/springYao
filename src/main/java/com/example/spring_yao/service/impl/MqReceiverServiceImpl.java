...
public class MqReceiverServiceImpl {
    ...
    public void receiverB(UserBasicEntity userBasicEntitiy){
        System.out.println(String.format("userBasicEntitiy : %s",userBasicEntitiy));
    }

    @RabbitListener(queues = RabbitmqConstant.YAO_01_C)
    @RabbitHandler
    public void receiverC(List<UserBasicListVO> userBasicListVOS){
        System.out.println(String.format("userBasicListVOS : %s",userBasicListVOS));
    }
...
//        System.out.println(String.format("DirectMq 測試: %s",direct));
    }
}
